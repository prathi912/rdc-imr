  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      if (relevantCallIds.length > 0) {
        ...
        // No calls assigned, so no interests to show.
        setEmrInterests([]);
      }
  ...
  return (
    <div className="container mx-auto py-10">
      <PageHeader
        ...
        description="Projects and presentations awaiting your review."
        ...
        <Tabs defaultValue="imr">
            ...
            {loading || !user ? (
              ...
              <Card>
                <CardContent className="py-12 text-center text-muted-foreground">
                  No IMR projects are currently awaiting your evaluation.
                </CardContent>
              </Card>
            )}
          </TabsContent>
          <TabsContent value="emr" className="mt-4">
            {loading ? (
              ...
              <EmrEvaluationList interests={emrInterests} calls={emrCalls} user={user!} onActionComplete={fetchData} />
            )}
          </TabsContent>
        </Tabs>
      </div>

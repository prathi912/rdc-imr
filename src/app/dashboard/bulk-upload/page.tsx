...
export default function BulkUploadPage() {
  ...
  const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (event) => {
      try {
        ...
        const optionalColumns = ["Department", "Campus"]
        ...
        if (!firstRow || !requiredColumns.every((col) => col in firstRow)) {
          toast({
            ...
            description: `The uploaded file must contain the following required columns: ${requiredColumns.join(", ")}. Optional columns: ${optionalColumns.join(", ")}.`,
            duration: 8000,
          })
          setData([])
          setFileName("")
  ...
  return (
    <div className="container mx-auto py-10">
      <PageHeader
        title="Bulk Upload Old Projects"
        description="Upload an Excel file to add historical project data to the system."
      />
        ...
        <Card>
          ...
          <CardContent>
            <Alert>
              ...
              <AlertDescription>
                Your Excel file must contain the following required columns:
                ...
                <br />
                Optional columns:
                <code className="font-mono text-sm bg-muted p-1 rounded-sm mx-1">Department</code>,
                <code className="font-mono text-sm bg-muted p-1 rounded-sm mx-1">Campus</code>.
              </AlertDescription>
            </Alert>
                  ...
                  <TableBody>
                    {data.map((row, index) => (
                      <TableRow key={index}>
                        ...
                        <TableCell>{row.Campus || "N/A"}</TableCell>
          ...
          <CardHeader>
            <div className="flex justify-between items-start">
              <div>
                ...
                <CardDescription>A list of all projects added via the bulk upload feature.</CardDescription>
              </div>
              <Button
                  ...
                  <TableBody>
                    {history.map((project) => (
                      <TableRow key={project.id}>
                        ...
                        <TableCell>{project.campus || "N/A"}</TableCell>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                ...
                <span className="font-bold">{projectToDelete.title}</span>" from the database.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>

...
export async function addPublication(publicationData: {
  ...
  try {
    if (!publicationData.title || !publicationData.authorUids || publicationData.authorUids.length === 0) {
    ...
    const publicationDoc = {
      ...
      authorUids: publicationData.authorUids,
      authorNames: publicationData.authorNames,
    ...
    // Update research domains for all authors asynchronously

...
const statCards = [
  ...
  { title: 'Pending Reviews', value: '32', icon: CheckCircle, change: '-3' },
  { title: 'Total Funding', value: '$2.5M', icon: DollarSign, change: '+$200k' },
  { title: 'Active Evaluators', value: '45', icon: Users, change: '+5' },
];

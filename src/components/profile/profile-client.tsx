                  ...
                  <div className="space-y-4">
                    {publications.map((publication) => (
                      <div key={publication.id} className="border rounded-lg p-4">
                        ...
                        <p className="text-xs text-muted-foreground mb-2 line-clamp-2">{publication.abstract}</p>
                        <div className="flex items-center gap-4 text-xs text-muted-foreground">
                          <div className="flex items-center gap-1">
                            <Calendar className="h-3 w-3" />
                            {format(new Date(publication.createdAt), "MMM yyyy")}
                          </div>
                          <div className="flex items-center gap-1">
                            <Building className="h-3 w-3" />
                            {publication.faculty}
                          ...
                          {publication.authors.length > 1 && (
                            <div className="flex items-center gap-1">
                              <Users className="h-3 w-3" />+{publication.authors.length - 1} Co-Author
                              {publication.authors.length - 1 > 1 ? "s" : ""}
                            </div>
                          )}
                        </div>
                      </div>
